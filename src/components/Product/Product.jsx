...
export default function Product() {
  ...
  let cart = useSelector((state) => state.cart);//arrow function
  ...
  return (
    ...
    <Section id="single-product">
      <article id="product-article-2">
        <img src={allProducts[id-1].img} alt="" id="main-img"  />
      ...
      <article id="product-article-3">
        ...
        <div id="price">
          <h2>{allProducts[id-1].name}</h2>
          <h3 className="price">
            ₹{allProducts[id-1].sprice} {" "}
           
          </h3>
          <h4 className="rating">
            <span>
              {allProducts[id-1].rating} <FaStar />
            </span>{" "}
          </h4>
